...
# 2) bot.py - only owner can use slash commands
p = Path("bot.py")
s = p.read_text()
...
p = Path("utils.py")
s = p.read_text()
s = s.replace("if xp >= 100000: return \"Elder Dragon\"", "if xp >= 5500000: return \"Elder Dragon\"")
s = s.replace("if xp >= 40000: return \"Ancient Dragon\"", "if xp >= 2200000: return \"Ancient Dragon\"")
s = s.replace("if xp >= 15000: return \"Adult Dragon\"", "if xp >= 825000: return \"Adult Dragon\"")
s = s.replace("if xp >= 5000: return \"Young Dragon\"", "if xp >= 275000: return \"Young Dragon\"")
s = s.replace("if xp >= 1000: return \"Hatchling\"", "if xp >= 55000: return \"Hatchling\"")
s = s.replace(
...
s = s.replace("if xp < 250:", "if xp < 13750:")
s = s.replace("if xp < 500:", "if xp < 27500:")
s = s.replace("if xp < 750:", "if xp < 41250:")
s = s.replace("if xp < 1000:", "if xp < 55000:")
p.write_text(s)

# 4) dragon.py - better energy balance
p = Path("dragon.py")
s = p.read_text()
